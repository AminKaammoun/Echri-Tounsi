...
if(isset($_POST['update'])){
   ...
   $sub_cate = intval($_POST['sub_category']);
   $sub_cate = filter_var($sub_cate, FILTER_SANITIZE_STRING);
   
   
   $update_product = $conn->prepare("UPDATE `products` SET name = ?, price = ?, details = ?, quantity = ?, id_under_category = ? WHERE id = ?");
   $update_product->execute([$name, $price, $details, $quantity,$sub_cate,$pid]);
